...
export function SidebarComponent() {
    ...
    return (
        <div class="sidebar p-2 d-flex flex-column gap-3 h-100">
            ...
            <Switch>                          
                ...
                <Match when={version.state === "unresolved" || version.state === "pending" || version.state === "refreshing"}>
                    <div class="alert alert-info text-center font-monospace m-0a">
                        Retrieving restic version...
                    </div>
                </Match>

                <Match when={version.state === "errored"}>
                    <div class="alert alert-danger text-center font-monospace m-0">
                        {version.error}
                    </div>
                </Match>
            </Switch>
